export const Skelton = () => {
    return (
        <div className="relative overflow-hidden my-[80px]">
      ...
      <div className="relative z-10">
        <div className='w-full m-auto xl:px-[9%] lg:px-10 md:px-3 px-3'>
          <div className="mb-4">
          <div className="bg-slate-700 h-[40px] xl:w-[222px] lg:w-[222px] md:w-[222px] w-full"></div>
          </div>

          <div className="flex justify-between gap-6 mt-10">
          <div className="bg-slate-700 h-[35px] xl:w-[100px] lg:w-[100px] md:w-[100px] w-full"></div>
          <div className="bg-slate-700 h-[35px] xl:w-[100px] lg:w-[100px] md:w-[100px] w-full"></div>
          <div className="bg-slate-700 h-[35px] xl:w-[100px] lg:w-[100px] md:w-[100px] w-full"></div>
          <div className="bg-slate-700 h-[35px] xl:w-[100px] lg:w-[100px] md:w-[100px] w-full"></div>
          <div className="bg-slate-700 h-[35px] xl:w-[100px] lg:w-[100px] md:w-[100px] w-full"></div>
